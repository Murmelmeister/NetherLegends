...
public enum Configs {
    ...
    FILE_NAME("FileName", "Lobby"),
    CURRENT_SERVER("CurrentServer", "Lobby"),
    PERMISSION_SPAWN("Permission.Spawn", "lobby.command.spawn"),
    PERMISSION_SET_SPAWN("Permission.SetSpawn", "lobby.command.setspawn"),
    PERMISSION_SPAWN_HEIGHT("Permission.SpawnHeight", "lobby.command.spawnheight"),
    PERMISSION_SET_SPAWN_HEIGHT("Permission.SetSpawnHeight", "lobby.command.setspawnheight"),
    PERMISSION_BUILD_COMMAND("Permission.Build.Command", "lobby.command.build.command"),
    PERMISSION_BUILD_USE("Permission.Build.Use", "lobby.command.build.use"),
    PERMISSION_BUILD_OTHER("Permission.Build.Other", "lobby.command.build.other"),
