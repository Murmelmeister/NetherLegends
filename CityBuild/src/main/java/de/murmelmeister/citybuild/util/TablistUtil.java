...
public final class TablistUtil {
    ...
    public void setScoreboardTabList() {
        ...
        player.sendPlayerListHeaderAndFooter(MiniMessage.miniMessage().deserialize(message.getString(Messages.SCOREBOARD_TAB_LIST_HEADER)
                ...
                MiniMessage.miniMessage().deserialize(message.getString(Messages.SCOREBOARD_TAB_LIST_FOOTER)));
    }
}
